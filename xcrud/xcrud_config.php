...
{
    // default connection
    public static $dbname = 'Ausway'; // Your database name
    public static $dbuser = '90fan'; // Your database username
    public static $dbpass = '998877'; // // Your database password
    ...
    // session
    public static $sess_name = 'PHP543SESSID'; // If your script is already using the session, specify the session name for it. By default, the name of the session in PHP equal 'PHPSESSID'.
